...
TEXTS = {
    ...
    "apartment_paid_notice": {
        "kk": (
            ...
            "Біз сізге сантехник пен электриктің пәтерлер ішіндегі жұмысы ақылы "
            "түрде орындалатынын хабарлаймыз.\n\n"
    ...
    "describe_apartment_work": {
        "kk": "Енді қажетті жұмысты және нақты орнын сипаттаңыз.",
        "ru": "Теперь опишите требуемую работу и точное место.",
    },
    "describe_common_problem": {
        "kk": "Ортақ пайдалану орнындағы мәселені сипаттап, нақты орнын көрсетіңіз.",
        "ru": "Опишите проблему в МОП и укажите точное место.",
    },
    "cleaning_closed_notice": {
        "kk": (
